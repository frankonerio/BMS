...
#define rx_write_fc_first_high_byte 13
#define rx_write_fc_first_low_byte 14

#define fixed_no_of_bytes_to_read 5

#define tx_bytes_till_message_end 8
#define tx_start_data_high_byte 9
#define tx_start_data_low_byte 10
